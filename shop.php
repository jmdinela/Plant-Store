...
<div class="heading">
   <h3>Our shop</h3>
   <p>
   <a href="#Interior">New | </a>
   <a href="#Interior">Interior | </a>
   <a href="#Health">Health | </a>
   <a href="#New">Beginner | </a>
   <a href="#Accessories">Acessories | </a>
   <a href="#Latest ">Show All</a>
   </p>
</div>

     <!-- Banner Area End Here -->

<section class="products" id='Interior'>
   ...
   <div class="box-container">
      ...
      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE `category`= 'Interior'") or die('query failed');
...
<section class="products" id="Health">
   ...
   <div class="box-container">
      ...
      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE `category`= 'Health'") or die('query failed');
         if(mysqli_num_rows($select_products) > 0){
            while($fetch_products = mysqli_fetch_assoc($select_products)){
      ?>
